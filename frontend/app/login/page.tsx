...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('https://api-finanalyzer.onrender.com/api/login', {
        method: 'POST',
      ...
      if (res.ok) {
        // Salva usuário e redireciona para o Dashboard
      ...
      <div className="w-full max-w-md bg-[#161b22] border border-gray-800 rounded-2xl shadow-2xl p-8 animate-in zoom-in-95 duration-500">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm">
            ...na plataforma de IA mais completa para investidores!
          </p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          {/* Esqueceu Senha e Erro */}
          <div className="flex items-center justify-between">
            <div className="text-red-400 text-xs font-medium h-4 flex items-center gap-1">
