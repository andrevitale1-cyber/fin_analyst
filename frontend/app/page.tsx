...
import { 
  ...
  FileText, Layout, Database, Check, X, CheckCircle2, Play, MousePointerClick
} from "lucide-react";
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0E1117] text-gray-100 font-sans selection:bg-blue-500/30">
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center mb-16">
            <Link href="/sign-up" className="bg-blue-600 hover:bg-blue-500 text-white px-8 py-4 rounded-xl text-lg font-semibold transition-all shadow-xl shadow-blue-900/20 hover:shadow-blue-900/40 hover:-translate-y-1 flex items-center justify-center gap-2">
          ...
          <div className="relative w-full max-w-6xl group perspective-1000">
             ...
             <img 
               ...
               className="relative rounded-2xl border border-gray-700/50 shadow-2xl bg-[#0E1117] w-full transform transition-transform duration-500 hover:scale-[1.01]"
             />
          </div>
        </div>
      </section>
      ...
      {/* =====================================================================================
          FUNCIONALIDADES (LAYOUT FUNDAMENTEI + APRESENTAÇÃO MODERNA)
      ===================================================================================== */}
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-16">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Badge text="Sem limite de tamanho" color="blue" />
                <Badge text="Identificação Automática" color="blue" />
                <Badge text="Processamento Rápido" color="blue" />
              </div>
            </div>

            {/* Imagem Apresentável (W-FIT) */}
        ...
        <section className="py-24 border-b border-gray-800/50 relative">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-16">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Badge text="Score (0 a 5)" color="green" />
                <Badge text="Indicadores Coloridos" color="green" />
                <Badge text="Tese Descritiva IA" color="green" />
              </div>
            </div>
        ...
        <section className="py-24 border-b border-gray-800/50 relative">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-16">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Badge text="Ordenação Inteligente" color="purple" />
                <Badge text="Comparação Lado a Lado" color="purple" />
              </div>
            </div>

            {/* AQUI ESTÁ A CORREÇÃO CRÍTICA (w-fit) */}
            <div className="relative w-fit mx-auto group">
        ...
        <section className="py-24 border-b border-gray-800/50 relative">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col items-center text-center max-w-4xl mx-auto mb-16">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Badge text="Backup na Nuvem" color="yellow" />
                <Badge text="Acesso Rápido" color="yellow" />
              </div>
            </div>
      ...
      {/* =====================================================================================
          PRICING (PLANOS - ORIGINAL PRESERVADO)
      ===================================================================================== */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-[#161B22] border border-gray-800 rounded-2xl p-8 flex flex-col hover:border-gray-600 transition-all">
              ...
              <Link href="/sign-up" className="w-full py-3 rounded-lg border border-gray-700 text-white font-medium hover:bg-gray-800 transition-colors text-center">
                Criar Conta Grátis
              </Link>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-400">
                ...
                <li><Link href="/sign-up" className="hover:text-blue-400 transition-colors">Criar Conta</Link></li>
                <li><Link href="/sign-in" className="hover:text-blue-400 transition-colors">Login</Link></li>
              </ul>
            </div>
...
function Badge({ text, color }: { text: string, color: 'blue' | 'green' | 'purple' | 'yellow' }) {
    const styles = {
    ...
    return (
        <div className={`px-4 py-2 rounded-full border flex items-center gap-2 text-sm font-medium ${styles[color]}`}>
